...
> 📦 **Example pack:** [Example Question Pack](https://github.com/donebd/SIGame/tree/main/pack-examples/readme-example) - a ready-made example pack structure with various question types and special cards.
